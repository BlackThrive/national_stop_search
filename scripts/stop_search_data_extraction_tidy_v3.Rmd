...
To avoid repeated retrieval of Cambridge stops, its coordinates were removed from the South Cambridgeshire element. In this way, stops could be retrieved independently for Cambridge and South Cambridgeshire. It should be noted that in analyses involving aggregating over LADs, this overlap must be accounted for. This can be done by removing the Cambridge stops from the dataset and keeping the broader South Cambridgeshire stops.
