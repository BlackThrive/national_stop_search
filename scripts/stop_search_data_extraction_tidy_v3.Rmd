...
```{r}
# Unzip data
files <- list.files(path="../data/", pattern=".zip$")
for (i in files) {
  unzip(paste0("../data/",i), exdir= "../data")
}
...
```{r eval = FALSE}
#full extraction may take a long time depending on the computing power of your machine
data <- la_search_police_api(ordered_coords, back_to_month = 1, back_to_year = 2019)
```
